/* ============================================================
   DADOS DO TREINO (extraídos da planilha da Nathaly)
============================================================ */
const PLANO = [
  {
    id:'seg', dow:'Segunda-feira', grupo:'Inferiores (Quadríceps) + Cardio', color:'pernas',
    exercicios:[
      { nome:'Agachamento Goblet', equip:'Haltere moderado à frente', series:4, reps:'12 a 15', descanso:60 },
      { nome:'Passada em Movimento / Avanço', equip:'Halteres nas mãos', series:3, reps:'14 passos totais', descanso:60 },
      { nome:'Agachamento Sumô', equip:'Haltere entre as pernas', series:4, reps:'15', descanso:60 },
      { nome:'Polichinelos (Estímulo Aeróbico)', equip:'Peso Corporal', series:3, reps:'45 segundos sem parar', descanso:30 },
    ]
  },
  {
    id:'ter', dow:'Terça-feira', grupo:'Superiores — Tonificação e Postura', color:'superior',
    exercicios:[
      { nome:'Remada Sentada', equip:'Elástico de pedal (amarelo)', series:4, reps:'15', descanso:45 },
      { nome:'Supino Reto no Chão', equip:'Halteres leves/moderados', series:3, reps:'12 a 15', descanso:60 },
      { nome:'Elevação Lateral', equip:'Halteres leves ou Elástico', series:4, reps:'12 a 15', descanso:45 },
      { nome:'Tríceps no Elástico', equip:'Elástico preso no alto', series:4, reps:'15 (foco no tchauzinho)', descanso:45 },
    ]
  },
  {
    id:'qua', dow:'Quarta-feira', grupo:'Posterior de Coxa, Glúteos + Core', color:'gluteo',
    exercicios:[
      { nome:'Stiff (alongando bem a coxa)', equip:'Halteres', series:4, reps:'12', descanso:60 },
      { nome:'Elevação Pélvica', equip:'Haltere no quadril + Miniband', series:4, reps:'15 (controle na subida)', descanso:60 },
      { nome:'Monster Walk (Passada Lateral)', equip:'Mini-band nos joelhos', series:3, reps:'20 passos totais', descanso:45 },
      { nome:'Abdominal Supra Reto', equip:'Peso Corporal', series:4, reps:'20 a 25', descanso:45 },
    ]
  },
  {
    id:'qui', dow:'Quinta-feira', grupo:'Circuito Queima de Gordura — HIIT', color:'hiit',
    exercicios:[
      { nome:'Agachamento Livre (sem carga)', equip:'Peso Corporal', series:4, reps:'20 (ritmo acelerado)', descanso:45 },
      { nome:'Corrida Estacionária (joelhos altos)', equip:'Peso Corporal', series:4, reps:'45 segundos ativo', descanso:30 },
      { nome:'Desenvolvimento de Ombros', equip:'Halteres leves', series:3, reps:'15', descanso:45 },
      { nome:'Prancha Isométrica', equip:'Peso Corporal', series:4, reps:'30 a 45 segundos', descanso:45 },
    ]
  },
  {
    id:'sex', dow:'Sexta-feira', grupo:'Full Body — Corpo Todo Integrado', color:'fullbody',
    exercicios:[
      { nome:'Agachamento Goblet', equip:'Haltere moderado', series:3, reps:'12', descanso:60 },
      { nome:'Remada Curvada', equip:'Halteres ou Elástico', series:3, reps:'12', descanso:60 },
      { nome:'Rosca Martelo + Elevação Frontal', equip:'Halteres leves', series:3, reps:'12 (exercício conjugado)', descanso:60 },
      { nome:'Abdominal Infra (Elevação de Pernas)', equip:'Peso Corporal', series:4, reps:'15', descanso:45 },
    ]
  },
];
...
/* ============================================================
   STORAGE
============================================================ */
const LS_PROGRESS = 'nathaly_treino_progress_v1';
const LS_STREAK   = 'nathaly_treino_streak_v1';
...
function setPhaseWork(){
  ...
  document.getElementById('btn-main-action').className='tbtn primary-coral';
...
function setPhaseRest(){
  ...
  document.getElementById('btn-main-action').className='tbtn primary-teal';
  document.getElementById('btn-pause').textContent='Pausar';
...
function showCompleteModal(day){
  ...
  document.getElementById('complete-text').textContent =
    `Você fechou o treino de ${day.dow.toLowerCase()} — ${day.grupo}. Sequência atual: ${streak.count} dia(s). Hidrate-se e mantenha a alimentação no foco — o resultado é a soma dos dois.`;
